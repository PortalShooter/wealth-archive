  ...
  return (
    <section className={cn('compare-side')}>
      <div className={cn('compare-side__wrapper')}>
        <h2 className={cn('compare-side__title', useScrollInView(title, { title: true }).titleSpawn)} ref={title}>
          {data.title}
        </h2>
        <h3 className={cn('compare-side__subtitle', useScrollInView(subtitle).spawnAnimation)} ref={subtitle}>
          {data.subtitle}
        </h3>
        <div className={cn('compare-side__columns', useScrollInView(info).spawnAnimation)} ref={info}>
